                    ...
                    <div class="row">
                        <div class="offset-lg-1 col-lg-10 col-md-12 col-12">
                            ...
                            <div class="bs-stepper-content mt-5">
                                <form id="quizForm" action="{{ route('admin.quizzes.update', $quiz->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <!-- Content one -->
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control @error('description') is-invalid @enderror" id="description"
                                                              name="description" rows="4" placeholder="Description">{{ $quiz->description }}</textarea>
                                                    @error('description')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                        ...
                                        <div class="card mb-3 border-0">
                                            ...
                                            <div class="card-body">
                                                <div class="mb-4">
                                                    ...
                                                    @if ($quiz->image)
                                                        <img src="{{ asset('storage/' . $quiz->image) }}" class="img-thumbnail mt-3" width="200">
                                                    @endif
                                                    @error('image')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                                    ...
                                                                    <div class="additional-answers-container">
                                                                        @foreach($question->answers as $answer)
                                                                            <div class="form-check">
                                                                                <input class="form-check-input" type="radio" name="question_{{ $question->id }}" id="answer{{ $answer->id }}" value="{{ $answer->id }}" {{ $answer->is_correct ? 'checked' : '' }}>
                                    ...
                                    <div id="test-l-4" role="tabpanel" class="bs-stepper-pane dstepper-none"
                                        ...
                                        <div class="card mb-3 border-0">
                                            ...
                                            <div class="card-body pb-0">
                                                ...
                                                <input type="text" name="tags" class="form-control @error('tags') is-invalid @enderror w-100" value="{{ $quiz->tags }}" placeholder="Tags">
                                                @error('tags')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            <div class="card-body">
                                                ...
                                                <div class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input" name="status" id="status" {{ $quiz->is_active ? 'checked' : '' }}>
                                                </div>
                                            </div>
                                        </div>
