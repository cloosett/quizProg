        ...
        <nav class="navbar-vertical navbar">
            <div class="vh-100 simplebar-scrollable-y" data-simplebar="init"><div class="simplebar-wrapper" style="margin: 0px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style="height: 100%; overflow: hidden scroll;"><div class="simplebar-content" style="padding: 0px;">
                                    ...
                                    <a class="navbar-brand" href="https://geeksui.codescandy.com/geeks/index.html">
                                        <img src="Dashboard%20Geeks%20-%20Bootstrap%205%20Admin%20Dashboard%20Template_files/logo-inverse.svg" alt="Geeks">
                                    </a>
                                    <!-- Navbar nav -->
                                    <ul class="navbar-nav flex-column" id="sideNavbar">
                                        <li class="nav-item">
                                            ...
                                            <div id="navDashboard" class="collapse  show " data-bs-parent="#sideNavbar">
                                                <ul class="nav flex-column">
                                                    <li class="nav-item">
                                                        <a class="nav-link  active " href="https://geeksui.codescandy.com/geeks/pages/dashboard/admin-dashboard.html">Overview</a>
                                                    </li>
                                                    <!-- Nav item -->
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/dashboard-analytics.html">Analytics</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                        <li class="nav-item">
                                            ...
                                            <div id="navCourses" class="collapse " data-bs-parent="#sideNavbar">
                                                <ul class="nav flex-column">
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/admin-course-overview.html">All Courses</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/admin-course-category.html">Courses Category</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/admin-course-category-single.html">Category Single</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div id="navProfile" class="collapse " data-bs-parent="#sideNavbar">
                                                <ul class="nav flex-column">
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/admin-instructor.html">Instructor</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/admin-students.html">Students</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div id="navCMS" class="collapse " data-bs-parent="#sideNavbar">
                                                <ul class="nav flex-column">
                                                    <li class="nav-item">
                                                        <a class="nav-link  active " href="https://geeksui.codescandy.com/geeks/pages/dashboard/admin-cms-overview.html">Overview</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/admin-cms-post.html">All Post</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/admin-cms-post-new.html">New Post</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/admin-cms-post-category.html">Category</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div id="navProject" class="collapse " data-bs-parent="#sideNavbar">
                                                <ul class="nav flex-column">
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/project-grid.html">Grid</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/project-list.html">List</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        ...
                                                        <div id="navprojectSingle" class="collapse " data-bs-parent="#navProject">
                                                            <ul class="nav flex-column">
                                                                <li class="nav-item">
                                                                    <a class="nav-link  active " href="https://geeksui.codescandy.com/geeks/pages/dashboard/project-overview.html">Overview</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/project-task.html">Task</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/project-budget.html">Budget</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/project-team.html">Team</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/project-files.html">Files</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/project-summary.html">Summary</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/add-project.html">Create Project</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div id="navAuthentication" class="collapse " data-bs-parent="#sideNavbar">
                                                <ul class="nav flex-column">
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/sign-in.html">Sign In</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/sign-up.html">Sign Up</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/forget-password.html">Forget Password</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/notification-history.html">Notifications</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/404-error.html">404 Error</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                                ...
                                                <ul class="nav flex-column">
                                                    <li class="nav-item">
                                                        ...
                                                        <div id="navproduct" class="collapse " data-bs-parent="#navProduct">
                                                            <ul class="nav flex-column">
                                                                <li class="nav-item">
                                                                    <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/ecommerce/product-grid.html">Grid</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/ecommerce/product-grid-with-sidebar.html">Grid Sidebar</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/ecommerce/products.html">Products</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/ecommerce/product-single.html">Product Single</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/ecommerce/product-single-v2.html">Product Single v2</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/ecommerce/add-product.html">Add Product</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/ecommerce/shopping-cart.html">Shopping Cart</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/ecommerce/checkout.html">Checkout</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/ecommerce/order.html">Order</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/ecommerce/order-single.html">Order Single</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/ecommerce/order-history.html">Order History</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/ecommerce/order-summary.html">Order Summary</a>
                                                    </li>

                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/ecommerce/customers.html">Customers</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/ecommerce/customer-single.html">Customer Single</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/ecommerce/add-customer.html">Add Customer</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div id="navlayouts" class="collapse " data-bs-parent="#sideNavbar">
                                                <ul class="nav flex-column">
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/layouts/layout-horizontal.html">Top</a>
                                                    </li>

                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/layouts/layout-compact.html">Compact</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/layouts/layout-vertical.html">Vertical</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                        ...
                                        <!-- Nav item -->
                                        <li class="nav-item">
                                            <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/chat-app.html">
                                        ...
                                        <!-- Nav item -->
                                        <li class="nav-item">
                                            <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/task-kanban.html">
          <span>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trello">
              ...
              <rect x="14" y="7" width="3" height="5"></rect>
                                        ...
                                        <!-- Nav item -->
                                        <li class="nav-item">
                                            <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/mail.html">
          <span>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail">
              ...
              <polyline points="22,6 12,13 2,6"></polyline>
                                        ...
                                        <!-- Nav item -->
                                        <li class="nav-item">
                                            <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/calendar.html">
          <span>
              ...
              <line x1="3" y1="10" x2="21" y2="10"></line>
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div id="navTables" class="collapse " data-bs-parent="#sideNavbar">
                                                <ul class="nav flex-column">
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/basic-table.html">Basic</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/datatables.html">Data Tables</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div id="navSiteSetting" class="collapse " data-bs-parent="#sideNavbar">
                                                <ul class="nav flex-column">
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/setting-general.html">General</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/setting-google.html">Google</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/setting-social.html">Social</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/setting-social-login.html">Social Login</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/setting-payment.html">Payment</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link " href="https://geeksui.codescandy.com/geeks/pages/dashboard/setting-smpt.html">SMPT</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                    ...
                                    <div class="card bg-dark-primary shadow-none text-center mx-4 my-8 border-0">
                                        <div class="card-body py-6">
                                            <img src="Dashboard%20Geeks%20-%20Bootstrap%205%20Admin%20Dashboard%20Template_files/giftbox.png" alt="">
                                            <div class="mt-4">
                                ...
                                </div></div></div></div><div class="simplebar-placeholder" style="width: 250px; height: 1502px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar" style="width: 0px; display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: visible;"><div class="simplebar-scrollbar" style="height: 619px; transform: translate3d(0px, 0px, 0px); display: block;"></div></div></div>
        </nav>
                            ...
                            <li class="dropdown stopevent">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-lg" aria-labelledby="dropdownNotification">
                                    ...
                                    <span class="align-middle">
                                        ...
                                        <!-- List group -->
                                        <ul class="list-group list-group-flush" data-simplebar="init" style="max-height: 300px"><div class="simplebar-wrapper" style="margin: 0px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style="height: auto; overflow: hidden;"><div class="simplebar-content" style="padding: 0px;">
                                                                <li class="list-group-item bg-light">
                                                                    <div class="row">
                                                                        <div class="col">
                                                                            <a class="text-body" href="#">
                                                                                <div class="d-flex">
                                                                                    <img src="Dashboard%20Geeks%20-%20Bootstrap%205%20Admin%20Dashboard%20Template_files/avatar-1.jpg" alt="" class="avatar-md rounded-circle">
                                                                                    <div class="ms-3">
                                                                ...
                                                                <li class="list-group-item">
                                                                    <div class="row">
                                                                        <div class="col">
                                                                            <a class="text-body" href="#">
                                                                                <div class="d-flex">
                                                                                    <img src="Dashboard%20Geeks%20-%20Bootstrap%205%20Admin%20Dashboard%20Template_files/avatar-2.jpg" alt="" class="avatar-md rounded-circle">
                                                                                    <div class="ms-3">
                                                            ...
                                                            <span class="ms-1">1:20 PM</span>
                                                                        ...
                                                                        <div class="col-auto text-center me-2">
                                                                            <a href="#" class="badge-dot bg-secondary" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Mark as unread" data-bs-original-title="Mark as unread"></a>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                                <li class="list-group-item">
                                                                    <div class="row">
                                                                        <div class="col">
                                                                            <a class="text-body" href="#">
                                                                                <div class="d-flex">
                                                                                    <img src="Dashboard%20Geeks%20-%20Bootstrap%205%20Admin%20Dashboard%20Template_files/avatar-3.jpg" alt="" class="avatar-md rounded-circle">
                                                                                    <div class="ms-3">
                                                                ...
                                                                <li class="list-group-item">
                                                                    <div class="row">
                                                                        <div class="col">
                                                                            <a class="text-body" href="#">
                                                                                <div class="d-flex">
                                                                                    <img src="Dashboard%20Geeks%20-%20Bootstrap%205%20Admin%20Dashboard%20Template_files/avatar-4.jpg" alt="" class="avatar-md rounded-circle">
                                                                                    <div class="ms-3">
                                        ...
                                        <div class="border-top px-3 pt-3 pb-0">
                                            <a href="https://geeksui.codescandy.com/geeks/pages/notification-history.html" class="text-link fw-semibold">See all Notifications</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="dropdown ms-2">
                                <a class="rounded-circle" href="#" role="button" id="dropdownUser" data-bs-toggle="dropdown" aria-expanded="false">
                                    <div class="avatar avatar-md avatar-indicators avatar-online">
                                        <img alt="avatar" src="Dashboard%20Geeks%20-%20Bootstrap%205%20Admin%20Dashboard%20Template_files/avatar-1.jpg" class="rounded-circle">
                                    </div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownUser">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="https://geeksui.codescandy.com/geeks/pages/profile-edit.html">
                                                <i class="fe fe-user me-2"></i>
                                                Profile
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="https://geeksui.codescandy.com/geeks/pages/student-subscriptions.html">
                                ...
                                Remove
                                    ...
                                    <li class="list-group-item px-0">
                                        <div class="row">
                                            <div class="col-auto">
                                                <div class="avatar avatar-md avatar-indicators avatar-online">
                                                    <img alt="avatar" src="Dashboard%20Geeks%20-%20Bootstrap%205%20Admin%20Dashboard%20Template_files/avatar-2.jpg" class="rounded-circle">
                                                </div>
                                            </div>
                                            <div class="col ms-n3">
                                        ...
                                        <div class="row">
                                            <div class="col-auto">
                                                <div class="avatar avatar-md avatar-indicators avatar-away">
                                                    <img alt="avatar" src="Dashboard%20Geeks%20-%20Bootstrap%205%20Admin%20Dashboard%20Template_files/avatar-3.jpg" class="rounded-circle">
                                                </div>
                                            </div>
                                            <div class="col ms-n3">
                                        ...
                                        <div class="row">
                                            <div class="col-auto">
                                                <div class="avatar avatar-md avatar-indicators avatar-info">
                                                    <img alt="avatar" src="Dashboard%20Geeks%20-%20Bootstrap%205%20Admin%20Dashboard%20Template_files/avatar-6.jpg" class="rounded-circle">
                                                </div>
                                            </div>
                                            <div class="col ms-n3">
                                        ...
                                        <div class="row">
                                            <div class="col-auto">
                                                <div class="avatar avatar-md avatar-indicators avatar-busy">
                                                    <img alt="avatar" src="Dashboard%20Geeks%20-%20Bootstrap%205%20Admin%20Dashboard%20Template_files/avatar-7.jpg" class="rounded-circle">
                                                </div>
                                            </div>
                                            <div class="col ms-n3">
                                    ...
                                    <li class="list-group-item px-0 pt-0">
                                        <div class="row flex-column flex-md-row gap-3 gap-md-0">
                                            ...
                                            <div class="col-md-3 col-12">
                                                <a href="#">
                                                    <img src="Dashboard%20Geeks%20-%20Bootstrap%205%20Admin%20Dashboard%20Template_files/course-laravel.jpg" alt="" class="img-fluid rounded">
                                                </a>
                                            </div>
                                            <!-- Col -->
                                            <div class="col-md-8 col-10">
                                                <div class="d-flex flex-column gap-2">
                                                    ...
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="Dashboard%20Geeks%20-%20Bootstrap%205%20Admin%20Dashboard%20Template_files/avatar-7.jpg" alt="" class="rounded-circle avatar-xs">
                              ...
                              <a class="dropdown-item" href="#">
                                ...
                                Remove
                                    ...
                                    <li class="list-group-item px-0">
                                        <div class="row flex-column flex-md-row gap-3 gap-md-0">
                                            <div class="col-md-3 col-12">
                                                <a href="#"><img src="Dashboard%20Geeks%20-%20Bootstrap%205%20Admin%20Dashboard%20Template_files/course-gatsby.jpg" alt="" class="img-fluid rounded"></a>
                                            </div>
                                            <div class="col-md-8 col-10">
                                                <div class="d-flex flex-column gap-2">
                                                    <a href="#">
                                                    ...
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="Dashboard%20Geeks%20-%20Bootstrap%205%20Admin%20Dashboard%20Template_files/avatar-8.jpg" alt="" class="rounded-circle avatar-xs">
                                ...
                                Remove
                                    ...
                                    <li class="list-group-item px-0">
                                        <div class="row flex-column flex-md-row gap-3 gap-md-0">
                                            <div class="col-md-3 col-12">
                                                <a href="#">
                                                    <img src="Dashboard%20Geeks%20-%20Bootstrap%205%20Admin%20Dashboard%20Template_files/course-javascript.jpg" alt="" class="img-fluid rounded">
                                                </a>
                                            </div>
                                            <div class="col-md-8 col-10">
                                                <div class="d-flex flex-column gap-2">
                                                    ...
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="Dashboard%20Geeks%20-%20Bootstrap%205%20Admin%20Dashboard%20Template_files/avatar-1.jpg" alt="" class="rounded-circle avatar-xs">
                                ...
                                Remove
                                    ...
                                    <li class="list-group-item px-0">
                                        <div class="row flex-column flex-md-row gap-3 gap-md-0">
                                            <div class="col-md-3 col-12">
                                                <a href="#">
                                                    <img src="Dashboard%20Geeks%20-%20Bootstrap%205%20Admin%20Dashboard%20Template_files/course-wordpress.jpg" alt="" class="img-fluid rounded">
                                                </a>
                                            </div>
                                            <div class="col-md-8 col-10">
                                                <div class="d-flex flex-column gap-2">
                                                    ...
                                                    <div class="d-flex align-items-center gap-2">
                                                        <img src="Dashboard%20Geeks%20-%20Bootstrap%205%20Admin%20Dashboard%20Template_files/avatar-5.jpg" alt="" class="rounded-circle avatar-xs">
                                ...
                                <ul class="list-group list-group-flush list-timeline-activity">
                                    ...
                                    <li class="list-group-item px-0 pt-0 border-0 mb-2">
                                        <div class="row">
                                            <div class="col-auto">
                                                <div class="avatar avatar-md avatar-indicators avatar-busy">
                                                    <img alt="avatar" src="Dashboard%20Geeks%20-%20Bootstrap%205%20Admin%20Dashboard%20Template_files/avatar-4.jpg" class="rounded-circle">
                                                </div>
                                            </div>
                                            <div class="col ms-n2">
                                                <div class="d-flex flex-column gap-1">
