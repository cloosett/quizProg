    ...
    <div class="db-content">
        <div class="container mb-4">
                    ...
                    <div class="d-flex flex-column gap-3">
                        ...
                        <div class="card h-100">
                            ...
                            <svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                              ...
                              <g id="7544f13f" clip-path="url(#c23d28ce)">
                                <path id="f036e129" fill-rule="evenodd" clip-rule="evenodd"
                                      ...
                                      fill="#754FFE"></path>
                                <path id="038035a8" fill-rule="evenodd" clip-rule="evenodd"
                              ...
                              <defs>
                                ...
                                <div class="d-flex flex-column gap-3">
                                    <p class="mb-0">Master JavaScript functions, event handling, and DOM
                                        interactions.</p>
                        ...
                        <span class="d-flex flex-row gap-2 align-items-center lh-1">
                          ...
                          <span>Total questions</span>
                                    ...
                                    <div>
                                        <span
                                            class="badge bg-warning-subtle border border-warning rounded-pill text-warning">In Process</span>
                                    </div>
                                </div>
                                <div class="d-flex flex-row align-items-center justify-content-between">
                                    ...
                                    <div class="d-flex flex-row">
                                        <a href="#!" class="btn-icon btn btn-ghost btn-sm rounded-circle"
                                           data-bs-toggle="tooltip" data-placement="top" aria-label="info"
                                        ...
                                        <a href="#!" class="btn-icon btn btn-ghost btn-sm rounded-circle"
                                           data-bs-toggle="tooltip" data-placement="top" aria-label="link"
                    ...
                    <div class="card border-success">
                        <div class="card-body d-flex flex-column gap-4">
                          ...
                          <svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                            ...
                            <div class="d-flex flex-row align-items-center justify-content-between">
                                <a href="../pages/quiz-result.html" class="btn btn-success">View Result</a>
                                <div class="d-flex flex-row">
                                    <a href="#!" class="btn-icon btn btn-ghost btn-sm rounded-circle"
                                       data-bs-toggle="tooltip" data-placement="top" aria-label="info"
                                       data-bs-original-title="info">
                    ...
                    <div class="card border-danger">
                        <div class="card-body d-flex flex-column gap-4">
                          ...
                          <svg width="12" height="12" viewBox="0 0 12 12" fill="none"
                            ...
                            <div class="d-flex flex-row align-items-center justify-content-between">
                                <a href="../pages/quiz-result.html" class="btn btn-danger">View Result</a>
                                <div class="d-flex flex-row">
                                    <a href="#!" class="btn-icon btn btn-ghost btn-sm rounded-circle"
                                       data-bs-toggle="tooltip" data-placement="top" aria-label="info"
                                       data-bs-original-title="info">
            ...
            @if ($quizzes->count() > 0)
                <div class="row gy-4">
                    <div class="col-12">
                        <h4 class="mb-0 h3">My Quizzes</h4>
                    </div>
                        ...
                        <div class="col-xxl-4 col-xl-6 col-12">
                                ...
                                <defs>
                                  <clipPath id="c23d28ce">
                                    <rect width="12" height="12" fill="white"></rect>
                                        ...
                                        <form action="{{ route('profile.destroyquiz', ['id' => $quiz->id]) }}" method="POST"
                                            ...
                                            <button type="submit" style="background: none; border: none">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M15.4142 2.58579L14.8284 1L8 7.8284L1.17157 1L0.585786 2.58579L7.41421 8L0.585786 13.4142L1.17157 15L8 8.17157L14.8284 15L15.4142 13.4142L8 7.58579L15.4142 2.58579Z" fill="#E63C3C"/>
                                                </svg>
                                            </button>
                                        </form>
                                    </div>
                          ...
                          <span class="d-flex flex-row gap-2 align-items-center lh-1">
                            ...
                            <span>Due Date</span>
                                                ...
                                                <span
                                                    class="fw-medium">{{ \Carbon\Carbon::parse($quiz->date)->format('d F, Y') }}</span>
                                            </li>
                                            <li class="d-flex flex-row align-items-center justify-content-between fs-5">
                          <span class="d-flex flex-row gap-2 align-items-center lh-1">
                            <span>
                            ...
                            <span>Time Limit</span>
                                                ...
                                                <span class="fw-medium">{{ $quiz->time }} minutes</span>
                                            </li>
                                            <li class="d-flex flex-row align-items-center justify-content-between fs-5">
                          <span class="d-flex flex-row gap-2 align-items-center lh-1">
                            <span>
                            ...
                            <span>Total questions</span>
                                                ...
                                                <span class="fw-medium">{{ $quiz->questions->count() }} MCQs</span>
                                            </li>
                                        </ul>
                                        <div>
                                            <span
                                                class="badge {{ $quiz->is_active ? 'bg-success-subtle text-success' : 'bg-danger-subtle text-danger' }} rounded-pill">
                                    ...
                                    <div class="row gap-2 gap-md-0">
                                        <div class="col-md-9 col-12">
                                            <div class="d-flex flex-row gap-2 align-items-center">
                                                ...
                                                <a href="{{ route('profile.editquiz', ['slug' => $quiz->slug] )}}" class="btn btn-outline-secondary">
                            <span>
