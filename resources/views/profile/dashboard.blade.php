        ...
        <div class="container mb-4">
                        ...
                        <div class="card-body d-flex flex-column gap-4 p-4">
                            <div class="d-flex flex-column gap-2">
                                <div class="d-flex flex-row justify-content-between">
                                    <img src="{{asset('images/avatar/default-avatar.png')}}" alt="avatar"
                            ...
                            <div class="d-flex flex-row gap-2">
                                <a href="#!">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <defs>
                                            <linearGradient id="paint0_linear_8175_5853" x1="12" y1="4" x2="12" y2="20"
                        ...
                        <div class="card-body p-5">
                            <div class="tns-outer" id="tns1-ow">
                                <div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">
                                    slide <span class="current">8</span> of 3
                                </div>
                                <div id="tns1-mw" class="tns-ovh">
                                    <div class="tns-inner" id="tns1-iw">
                                        <div
                                            class="slider dashboard-slider  tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal"
                                            id="tns1"
                                            style="transform: translate3d(-63.6364%, 0px, 0px); transition-duration: 0s;">
                                                ...
                                                <div class="row align-items-center gy-5">
                                                        ...
                                                        <div class="d-flex flex-column gap-4">
                                                            <div class="d-flex flex-column gap-2">
                                                                ...
                                                                <p class="mb-0">
                                                                    ...
                                                                    boosts effectiveness and success. We suggest you
                                                                    start by taking a
                                                                    moment to think about what you want to achieve
                                                                </p>
                                                            </div>
                                                            <div>
                                                                <a href="#!" class="btn btn-dark">Create a Learning
                                                                    Path</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="text-center d-xl-block d-none">
                                                            <img
                                                                src="{{ asset("images/svg/education.svg") }}"
                                                                alt="education">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="tns-item tns-slide-cloned" aria-hidden="true" tabindex="-1">
                                                <div class="row align-items-center gy-5">
                                                        ...
                                                        <div class="d-flex flex-column gap-4">
                                                            <div class="d-flex flex-column gap-2">
                                                                ...
                                                                <p class="mb-0">Earn&nbsp;industry-
                                                                    recognized&nbsp;certifications&nbsp;by passing the
                                                                    required exams that
                                                                    include questions reflecting real world problems
                                                                    faced in a job.</p>
                                                            </div>
                                                            <div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="text-center d-xl-block d-none">
                                                            <img
                                                                src="{{ asset('images/svg/certificates.svg') }}"
                                                                alt="certificates">
                                                        </div>
                                                    </div>
                                                </div>
            ...
            <div class="row g-4 mb-5">
                ...
                <div class="col-xl-3 col-md-6 col-12">
                    <!-- Card -->
                    <div class="card">
                        <a href="#"><img src="{{asset('images/course/course-javascript.jpg')}}" alt="course"
                ...
                <div class="col-xl-3 col-md-6 col-12">
                    <!-- Card -->
                    <div class="card">
                        <a href="#"><img src="{{asset('images/course/course-python.jpg')}}" alt="course"
                                         class="card-img-top"></a>
                        <!-- Card body -->
                        <div class="card-body d-flex flex-column gap-3">
                            ...
                            <div>
                                <span
                                    class="badge bg-light-subtle border rounded-pill text-secondary">Not Started</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 col-12">
                    <!-- Card -->
                    <div class="card">
                        <a href="#"><img src="{{asset('images/course/course-react.jpg')}}" alt="course"
                                         class="card-img-top"></a>
                        <!-- Card body -->
                        <div class="card-body d-flex flex-column gap-3">
