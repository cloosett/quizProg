        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
                ...
                <div class="mb-4">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="fs-4 mt-4">
                            <!--Facebook-->
                            <a href="home-academy.html#" class="me-2">
            ...
            <div class="offset-lg-1 col-lg-2 col-md-3 col-6">
                <div class="mb-4">
                    ...
                    <ul class="list-unstyled nav nav-footer flex-column nav-x-0">
                        <li><a href="home-academy.html#" class="nav-link">About</a></li>
                        <li><a href="home-academy.html#" class="nav-link">Pricing</a></li>
                        <li><a href="home-academy.html#" class="nav-link">Blog</a></li>
                        <li><a href="home-academy.html#" class="nav-link">Careers</a></li>
                        <li><a href="home-academy.html#" class="nav-link">Contact</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2 col-md-3 col-6">
                <div class="mb-4">
                    ...
                    <ul class="list-unstyled nav nav-footer flex-column nav-x-0">
                        <li><a href="home-academy.html#" class="nav-link">Help and Support</a></li>
                        <li><a href="home-academy.html#" class="nav-link">Become Instructor</a></li>
                        <li><a href="home-academy.html#" class="nav-link">Get the app</a></li>
                        <li><a href="home-academy.html#" class="nav-link">FAQ’s</a></li>
                        <li><a href="home-academy.html#" class="nav-link">Tutorial</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-3 col-md-12">
                ...
                <div class="mb-4">
                    ...
                    <p class="mb-1">
                        Email:
                        <a href="home-academy.html#">support@geeksui.com</a>
                    </p>
                    <p>
                        Phone:
                    ...
                    <div class="d-flex">
                        <a href="home-academy.html#"><img src="../../assets/images/svg/appstore.svg" alt="" class="img-fluid" /></a>
                        <a href="home-academy.html#" class="ms-2"><img src="../../assets/images/svg/playstore.svg" alt="" class="img-fluid" /></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="d-lg-flex align-items-center">
                    ...
                    <div>
                        <nav class="nav nav-footer">
                            <a class="nav-link ps-0" href="home-academy.html#">Privacy Policy</a>
                            <a class="nav-link px-2 px-md-3" href="home-academy.html#">Cookie Notice</a>
                            <a class="nav-link d-none d-lg-block" href="home-academy.html#">Do Not Sell My Personal Information</a>
                            <a class="nav-link" href="home-academy.html#">Terms of Use</a>
                        </nav>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-2 d-md-flex justify-content-end">
                <div class="dropdown">
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <li>
                            <a class="dropdown-item" href="home-academy.html#">
                                <span class="me-2">
