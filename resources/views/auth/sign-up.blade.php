            ...
            <div class="col-lg-5 col-md-8 py-8 py-xl-0">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body p-6 d-flex flex-column gap-4">
                        <div>
                            <a href="https://geeksui.codescandy.com/geeks/index.html"><img src="{{asset('images/svg/logo-icon.svg')}}" class="mb-4" alt="logo"></a>
                            <div class="d-flex flex-column gap-1">
                                <h1 class="mb-0 fw-bold">Sign up</h1>
                                <span>
                      Already have an account?
                      <a href="{{route('sign-in')}}" class="ms-1">Sign in</a>
                    </span>
                            </div>
                        </div>
                        <!-- Form -->
                        <form class="needs-validation" action="{{route('sign-up.store')}}" method="post">
                            @csrf
                            <!-- Username -->
                            <div class="mb-3">
                        ...
                        <span>
                          I agree to the
                          <a href="https://geeksui.codescandy.com/geeks/pages/terms-condition-page.html">Terms of Service</a>
                          and
                          <a href="https://geeksui.codescandy.com/geeks/pages/terms-condition-page.html">Privacy Policy.</a>
                        </span>
                                    </label>
