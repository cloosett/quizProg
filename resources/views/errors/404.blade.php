        ...
        <div class="row">
            <div class="offset-xl-1 col-xl-10 col-md-12 col-12">
                <div class="mt-4 d-flex justify-content-between align-items-center">
                    <a href="../index.html"><img src="{{asset('images/brand/logo/logo.svg')}}" alt="logo" class="logo-inverse"></a>
                    <div>
                        <div class="dropdown">
        ...
        <div class="row align-items-center justify-content-center g-0 h-lg-100 py-10">
            ...
            <div class="offset-xl-1 col-xl-4 col-lg-6 col-md-12 col-12 text-center text-lg-start">
                <div class="d-flex flex-column gap-5">
                    ...
                    <div>
                        <a href="{{route('welcome')}}" class="btn btn-primary me-2">Back to Safety</a>
                    </div>
                </div>
            </div>
            <!-- img -->
            <div class="offset-xl-1 col-xl-6 col-lg-6 col-md-12 col-12 mt-8 mt-lg-0">
                <img src="{{asset('images/errors/404-error-img.svg')}}" alt="error" class="w-100">
            </div>
        </div>
        <div class="row">
